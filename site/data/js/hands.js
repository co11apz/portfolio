...
const handURL = '/mysite/site/data/assets/hand_noNormals_optimized_AnnaTheScavenger.glb';
const steelURL = '/mysite/site/data/assets/img/hands/matcap_steel_256.jpg';
const purpleGlassURL = '/mysite/site/data/assets/img/hands/matcapPurpleGlass_256.png';
...
function initStardust() {
  ...
  // Thanks to: https://jsfiddle.net/prisoner849/yzx8fbqu/
...
function animateInstances() {
  ...
  // Read about this bug - .getElapsedTime() and .getDelta():
